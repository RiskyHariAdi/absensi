<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Aplikasi Absensi</h2>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
										...
										<center>
											<img src="../assets/img/logosmk1.png" width="100">
											<br>
											<b>SMK CITRA MUTIARA</b>
										</center>
									</div>
									<div class="card-category">
										<center>
										Jl. Langkap Lancar, Sukaragam, Kec. Serang Baru, Kabupaten Bekasi, Jawa Barat 17340
	<br>Email : smkcitramutiara@gmail.com Telp.081222333445
										</center>
									</div>
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
											<p>
												...
												Aplikasi Absensi siswa ini dibuat untuk mendokumentasikan kehadiran siswa, Aplikasi ini sangat mudah digunakan (Berbasis web)
											</p>
										</div>
									</div>
								</div>
