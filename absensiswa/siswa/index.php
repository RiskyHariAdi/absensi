...
<head>
	...
	<title>Siswa | Aplikasi Absensi</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<!-- <img src="../assets/img/logosmk1.png" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white">SMK CITRA MUTIARA</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMK CITRA MUTIARA (<a href="index.php">Risky HariAdi </a> | 2023)
					</div>				
				</div>
			</footer>
		</div>
